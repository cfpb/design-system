...
related_items: "[Notifications](https://cfpb.github.io/design-system/components\
  /banner-notification)"
last_updated: 2026-04-14T11:18:00.000-05:00
---
<VariationGroup
  title={`Types`}
>
  <Variation
    ...
    description={`The warning banner is used to display high-priority system or product level notifications that are not specific to an immediate task.`}
    code={`<div class="o-banner">
      <div class="wrapper wrapper--match-content">
          <div class="m-notification
                      m-notification--visible
                      m-notification--warning">
  ...
  <Variation
    title={`Archived content banner`}
    description={`The archived content banner is used to identify website pages that are outdated and should no longer be referenced for guidance. These pages may have historical value or significance to researchers, historians, and the public.`}
    code={`<div class="o-banner o-banner--dark">
      <div class="wrapper wrapper--match-content">
          <div class="m-notification
                      m-notification--warning
                      m-notification--visible">
...
<Section title={`Use cases`}>
  Use the banner notification to communicate important information about the state or status of page content or to highlight high-priority system or product level information. Use the inline notification instead when calling out specific page content or when alerting users to information that is specific to an immediate task.
</Section>

<Section title={`Guidelines`}>
  Banner notifications are positioned at the top of the page content area and span the full width.
</Section>

<Section title={`Related items`}>
  [Notifications](https://cfpb.github.io/design-system/components/banner-notification)
</Section>
