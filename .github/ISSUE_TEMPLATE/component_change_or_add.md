---
name: Component change or addition request
...
***For documentation requests, use the documentation request issue template instead.***
 

**Before filling out the information below, be sure you can answer "yes" to one of the following questions and be sure to include that detail in the issue:**

***Change an existing component:***
- Is the proposed change due to an accessbility or usability issue with the existing component?
...
- Indicate whether you are requesting to make a change to an existing component or requesting to add a new component to the Design System
- Provide any data or research you have to show that the proposed change is accessbile and usable
- Supply any design and development context for the request you may have (e.g. Figma concepts, code samples, etc.)
- Indicate whether you can design and build the proposed change or whether you will need to request that someone makes the changes for you
- Provide the content for the proposed change to be included in the Design System website (this can be included in this issue or in the comments)
