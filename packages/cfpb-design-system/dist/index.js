...
var xe = /* @__PURE__ */ t({}), L = "o-summary";
function Se(e) {
	let t = C(e, L), n = t.classList.contains(`${L}--mobile`), r = t.querySelector(`.${L}__content`), i = t.querySelector(`.${L}__btn`), a, o, s;
	function c() {
...
Se.BASE_CLASS = L, Se.init = (e) => T(`.${L}`, Se, e);
//#endregion
//#region packages/cfpb-design-system/src/components/cfpb-expandables/summary-minimal.js
var Ce = "o-summary-minimal";
function we(e) {
	let t = C(e, Ce), n = t.querySelector(`.${Ce}__content`), r = t.querySelector(`.${Ce}__btn`), i, a;
	function o() {
...
we.BASE_CLASS = Ce, we.init = (e) => T(`.${Ce}`, we, e);
//#endregion
//#region packages/cfpb-design-system/src/components/cfpb-forms/form.scss
var Te = /* @__PURE__ */ t({}), Ee = /* @__PURE__ */ t({}), De = /* @__PURE__ */ t({}), Oe = /* @__PURE__ */ t({}), ke = /* @__PURE__ */ t({}), Ae = /* @__PURE__ */ t({}), je = /* @__PURE__ */ t({}), Me = /* @__PURE__ */ t({}), Ne = /* @__PURE__ */ t({});
function Pe(e) {
	return e.replace(/[-\\^$*+?.()|[\]{}]/g, "\\$&");
}
function Fe(e, t) {
	return RegExp(Pe(t.trim()), "i").test(e);
}
function Ie(e, t, n) {
...
var Le = "<svg xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" class=\"cf-icon-svg cf-icon-svg--error\" viewBox=\"0 0 12 19\"><path d=\"M11.383 13.644A1.03 1.03 0 0 1 9.928 15.1L6 11.172 2.072 15.1a1.03 1.03 0 1 1-1.455-1.456l3.928-3.928L.617 5.79a1.03 1.03 0 1 1 1.455-1.456L6 8.261l3.928-3.928a1.03 1.03 0 0 1 1.455 1.456L7.455 9.716z\"/></svg>", Re = Le, z = "o-multiselect", ze = "a-checkbox", Be = "prev", Ve = "next", He = "Enter", Ue = " ", We = "Escape", Ge = "ArrowUp", Ke = "ArrowDown", qe = "Tab", Je = {
	renderTags: !0,
	maxSelections: 5
};
function Ye(e) {
	e.classList.add(z);
	let t = C(e, z), n = !1, r, i, a, o, s, c, l, u, d, f, p, m = [], h;
	function g() {
	...
	function E(e) {
		e === Ve ? a.setIndex(a.getIndex() + 1) : e === Be && a.setIndex(a.getIndex() - 1);
		let t = a.getIndex();
		if (t > -1) {
	...
	function te(e, t) {
		let n = k(t), r = R("li", null, { "data-option": t.value }), i = R("button", r, {
			type: "button",
			class: "a-tag-filter",
			innerHTML: "<label for=" + n + ">" + t.text + Re + "</label>"
		});
	...
	function ie() {
		u.addEventListener("mousemove", function(e) {
			...
			let t = e.key;
			f.getAttribute("aria-hidden") === "true" && t !== qe && S(), t === He ? (e.preventDefault(), E(Ve)) : t === We ? (ee(), T()) : t === Ke ? E(Ve) : t === qe && !e.shiftKey && f.getAttribute("aria-hidden") === "false" && T();
			...
			if (t === He) {
				...
				n.dispatchEvent(t);
			} else t === We ? (d.focus(), T()) : t === Ge ? E(Be) : t === Ke && E(Ve);
	...
	function ae() {
		c = document.createElement("div"), c.className = z, l = R("ul", null, { className: "m-tag-group" }), u = R("header", c, { className: z + "__header" }), d = R("input", u, {
			className: z + "__search a-text-input",
			type: "text",
			placeholder: i || "Select up to five",
			id: t.id,
			autocomplete: "off"
		}), f = R("fieldset", c, {
			className: z + "__fieldset u-invisible",
			"aria-hidden": "true"
		});
		let e = z + "__options";
		a.isAtMaxSelections() && (e += " u-max-selections"), p = R("ul", f, { className: e });
		let n, h, g;
		for (let e = 0, t = o.length; e < t; e++) {
			...
			R("input", t, {
				...
				value: n.value,
				name: r,
				class: ze + " o-multiselect__checkbox",
				checked: g,
				"data-index": e
			}), R("label", t, {
				for: h,
				textContent: n.text,
				className: z + "__label a-label"
...
Ye.BASE_CLASS = z, Ye.init = (e) => T(`.${z}`, Ye, void 0, e);
//#endregion
//#region packages/cfpb-design-system/src/components/cfpb-icons/icon.scss
var Xe = /* @__PURE__ */ t({}), Ze = /* @__PURE__ */ t({}), Qe = /* @__PURE__ */ t({}), $e = /* @__PURE__ */ t({}), et = /* @__PURE__ */ t({}), tt = /* @__PURE__ */ t({}), nt = /* @__PURE__ */ t({}), rt = /* @__PURE__ */ t({}), it = /* @__PURE__ */ t({}), at = /* @__PURE__ */ t({}), ot = /* @__PURE__ */ t({}), st = /* @__PURE__ */ t({}), ct = /* @__PURE__ */ t({}), lt = /* @__PURE__ */ t({}), ut = /* @__PURE__ */ t({}), dt = /* @__PURE__ */ t({}), ft = /* @__PURE__ */ t({}), pt = /* @__PURE__ */ t({}), mt = /* @__PURE__ */ t({}), ht = /* @__PURE__ */ t({}), gt = globalThis, _t = gt.ShadowRoot && (gt.ShadyCSS === void 0 || gt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, vt = Symbol(), yt = /* @__PURE__ */ new WeakMap(), bt = class {
	constructor(e, t, n) {
	...
	get styleSheet() {
		...
		if (_t && e === void 0) {
			...
			n && (e = yt.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), n && yt.set(t, e));
		}
		return e;
	}
	toString() {
...
}, xt = (e) => new bt(typeof e == "string" ? e : e + "", void 0, vt), B = (e, ...t) => new bt(e.length === 1 ? e[0] : t.reduce(((t, n, r) => t + ((e) => {
	if (!0 === e._$cssResult$) return e.cssText;
	if (typeof e == "number") return e;
	throw Error("Value passed to 'css' function must be a 'css' function result: " + e + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
})(n) + e[r + 1]), e[0]), e, vt), St = (e, t) => {
	if (_t) e.adoptedStyleSheets = t.map(((e) => e instanceof CSSStyleSheet ? e : e.styleSheet));
	else for (let n of t) {
		let t = document.createElement("style"), r = gt.litNonce;
		r !== void 0 && t.setAttribute("nonce", r), t.textContent = n.cssText, e.appendChild(t);
	}
}, Ct = _t ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((e) => {
	let t = "";
...
:host .a-btn--link:has(svg) {
  gap: 0.3125rem;
}
:host .a-btn--link:has(svg)::before {
  display: none;
}
:host .a-btn--link, :host .a-btn--link:link, :host .a-btn--link:visited {
  text-decoration-color: var(--link-text);
  background-color: transparent;
  color: var(--link-text);
}
:host .a-btn--link:hover, :host .a-btn--link.hover {
...
:host .a-btn--link:focus, :host .a-btn--link.focus {
  background-color: transparent;
  outline: 1px dotted var(--link-text);
  color: var(--link-text);
}
:host .a-btn--link:active, :host .a-btn--link.active {
  text-decoration-color: var(--link-text-active);
  text-decoration-style: solid;
  background-color: transparent;
  color: var(--link-text-active);
}
:host .a-btn--link.a-btn--warning, :host .a-btn--link.a-btn--warning:link, :host .a-btn--link.a-btn--warning:visited {
  text-decoration-color: var(--btn-warning-bg);
  background-color: transparent;
  color: var(--btn-warning-bg);
}
:host .a-btn--link.a-btn--warning:hover, :host .a-btn--link.a-btn--warning.hover {
  text-decoration-color: var(--btn-warning-bg-hover);
  text-decoration-style: solid;
  background-color: transparent;
  color: var(--btn-warning-bg-hover);
  box-shadow: none;
}
:host .a-btn--link.a-btn--warning:focus, :host .a-btn--link.a-btn--warning.focus {
  background-color: transparent;
  outline: 1px dotted var(--btn-warning-bg);
  color: var(--btn-warning-bg);
}
:host .a-btn--link.a-btn--warning:active, :host .a-btn--link.a-btn--warning.active {
  text-decoration-color: var(--btn-warning-bg-active);
  text-decoration-style: solid;
  background-color: transparent;
  color: var(--btn-warning-bg-active);
}
...
@media only screen and (max-width: 37.5em) {
  ...
  :host([full-on-mobile]) button,
  :host([full-on-mobile]) [role=button] {
    width: 100%;
  }
}

:host([flush-left]) button,
:host([flush-left]) [role=button] {
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
}

:host([flush-right]) button,
:host([flush-right]) [role=button] {
...
:host .m-form-field .a-label + .a-text-input {
  margin-top: 0.3125em;
}
:host .m-form-field--checkbox .a-label, :host .m-form-field--radio .a-label {
  display: inline-grid;
...
:host .m-form-field--checkbox .a-checkbox,
:host .m-form-field--checkbox .a-radio, :host .m-form-field--radio .a-checkbox,
:host .m-form-field--radio .a-radio {
  position: absolute;
  width: 1px;
  height: 1px;
  border: 0;
...
:host .m-form-field--checkbox .a-checkbox:focus + .a-label, :host .m-form-field--checkbox .a-checkbox.focus + .a-label,
:host .m-form-field--checkbox .a-radio:focus + .a-label,
:host .m-form-field--checkbox .a-radio.focus + .a-label, :host .m-form-field--radio .a-checkbox:focus + .a-label, :host .m-form-field--radio .a-checkbox.focus + .a-label,
:host .m-form-field--radio .a-radio:focus + .a-label,
:host .m-form-field--radio .a-radio.focus + .a-label {
  outline: 1px dotted var(--choice-outline-focus);
  outline-offset: 1px;
}
:host .m-form-field--checkbox .a-checkbox:disabled + .a-label,
:host .m-form-field--checkbox .a-radio:disabled + .a-label, :host .m-form-field--radio .a-checkbox:disabled + .a-label,
:host .m-form-field--radio .a-radio:disabled + .a-label {
  cursor: not-allowed;
  color: var(--choice-label-disabled);
}
:host .m-form-field--checkbox:has(.a-checkbox:disabled), :host .m-form-field--checkbox:has(.a-radio:disabled), :host .m-form-field--radio:has(.a-checkbox:disabled), :host .m-form-field--radio:has(.a-radio:disabled) {
...
:host .m-form-field--checkbox-success, :host .m-form-field--checkbox-warning, :host .m-form-field--checkbox-error, :host .m-form-field--radio-success, :host .m-form-field--radio-warning, :host .m-form-field--radio-error {
  --choice-border-width-addendum: 1px;
}
:host .m-form-field--checkbox-success, :host .m-form-field--radio-success {
  --choice-border: var(--choice-border-success);
}
:host .m-form-field--checkbox-warning, :host .m-form-field--radio-warning {
  --choice-border: var(--choice-border-warning);
}
:host .m-form-field--checkbox-error, :host .m-form-field--radio-error {
  --choice-border: var(--choice-border-error);
}
:host .m-form-field--radio input:disabled:checked + .a-label::before, :host .m-form-field--radio input:disabled:focus + .a-label::before, :host .m-form-field--radio input:disabled.focus + .a-label::before, :host .m-form-field--radio input:disabled:hover + .a-label::before, :host .m-form-field--radio input:disabled.hover + .a-label::before {
  border-color: var(--choice-border);
  outline: none;
  box-shadow: none;
}
:host .m-form-field--radio input:disabled + .a-label::before {
  outline: none;
}
:host .m-form-field--radio:hover::before, :host .m-form-field--radio.hover::before {
  border-color: var(--choice-border-hover);
}
:host .m-form-field--radio .a-label::before {
...
:host .m-form-field--radio .a-radio:focus + .a-label::before, :host .m-form-field--radio .a-radio.focus + .a-label::before {
  outline: none;
  border-color: var(--choice-border-focus);
  box-shadow: 0 0 0 1px var(--choice-border-focus);
}
:host .m-form-field--radio .a-radio:hover + .a-label::before, :host .m-form-field--radio .a-radio.hover + .a-label::before {
  outline: none;
  border-color: var(--choice-border-hover);
  box-shadow: 0 0 0 1px var(--choice-border-hover);
}
:host .m-form-field--radio .a-radio:checked + .a-label::before {
  background-color: var(--choice-bg-selected);
  box-shadow: inset 0 0 0 2px var(--white);
}
:host .m-form-field--radio .a-radio:focus:checked + .a-label::before, :host .m-form-field--radio .a-radio.focus:checked + .a-label::before {
  background-color: var(--choice-bg-selected-focus);
  border-color: var(--choice-border-focus);
  box-shadow: 0 0 0 1px var(--choice-border-focus), inset 0 0 0 2px var(--white);
}
:host .m-form-field--radio .a-radio:hover:checked + .a-label::before, :host .m-form-field--radio .a-radio.hover:checked + .a-label::before {
  border-color: var(--choice-border-hover);
  box-shadow: 0 0 0 1px var(--choice-border-hover), inset 0 0 0 2px var(--white);
}
:host .m-form-field--radio .a-radio:checked:disabled + .a-label::before, :host .m-form-field--radio .a-radio:hover:checked:disabled + .a-label::before, :host .m-form-field--radio .a-radio.hover:checked:disabled + .a-label::before {
  background-color: var(--choice-bg-selected);
  box-shadow: inset 0 0 0 2px var(--gray-10);
  border-color: var(--choice-border-disabled);
}
:host .m-form-field--lg-target {
  width: 100%;
  display: block;
}
:host .m-form-field--lg-target .a-label {
  box-sizing: border-box;
  width: 100%;
  padding: 15px;
  background-color: var(--form-field-input-lg-target-bg);
}
:host .m-form-field--lg-target .a-checkbox:checked + .a-label,
:host .m-form-field--lg-target .a-radio:checked + .a-label {
...
:host .m-form-field--lg-target .a-checkbox:hover + .a-label, :host .m-form-field--lg-target .a-checkbox.hover + .a-label, :host .m-form-field--lg-target .a-checkbox:focus + .a-label, :host .m-form-field--lg-target .a-checkbox.focus + .a-label,
:host .m-form-field--lg-target .a-radio:hover + .a-label,
:host .m-form-field--lg-target .a-radio.hover + .a-label,
:host .m-form-field--lg-target .a-radio:focus + .a-label,
:host .m-form-field--lg-target .a-radio.focus + .a-label {
  box-shadow: inset 0 0 0 2px var(--form-field-input-lg-target-border);
}
:host .m-form-field--lg-target .a-checkbox:focus + .a-label, :host .m-form-field--lg-target .a-checkbox.focus + .a-label, :host .m-form-field--lg-target .a-checkbox:checked + .a-label,
:host .m-form-field--lg-target .a-radio:focus + .a-label,
:host .m-form-field--lg-target .a-radio.focus + .a-label,
:host .m-form-field--lg-target .a-radio:checked + .a-label {
  outline-offset: 1px;
}
:host .m-form-field--lg-target .a-checkbox:disabled + .a-label, :host .m-form-field--lg-target .a-checkbox:checked:disabled + .a-label, :host .m-form-field--lg-target .a-checkbox:hover:disabled + .a-label,
:host .m-form-field--lg-target .a-radio:disabled + .a-label,
:host .m-form-field--lg-target .a-radio:checked:disabled + .a-label,
:host .m-form-field--lg-target .a-radio:hover:disabled + .a-label {
  color: var(--choice-label-disabled);
  box-shadow: none;
  background-color: var(--form-field-input-lg-target-bg-disabled);
}
:host .m-form-field--lg-target .a-checkbox:checked:disabled + .a-label,
:host .m-form-field--lg-target .a-radio:checked:disabled + .a-label {
...
:host .a-label__helper {
  color: var(--label-helper);
  font-size: 1rem;
  font-weight: normal;
}
:host .a-label__helper--block {
  display: block;
  margin-top: 0.8333333333em;
}
:host .a-label--heading {
  display: block;
...
p + :host .a-label--heading, ul + :host .a-label--heading, ol + :host .a-label--heading, dl + :host .a-label--heading, figure + :host .a-label--heading, img + :host .a-label--heading, table + :host .a-label--heading, blockquote + :host .a-label--heading, h1 + :host .a-label--heading, .h1 + :host .a-label--heading, h2 + :host .a-label--heading, .h2 + :host .a-label--heading, h3 + :host .a-label--heading, .h3 + :host .a-label--heading, h5 + :host .a-label--heading, .h5 + :host .a-label--heading, h6 + :host .a-label--heading, .h6 + :host .a-label--heading {
  margin-top: 1.6666666667em;
}
@media only screen and (max-width: 37.5em) {
  :host .a-label--heading {
...
:host .a-label--heading .a-label__helper--block {
  margin-top: 0.625rem;
}`, sr = (e) => e ?? q, cr = class e extends X {
	static styles = or;
	static properties = {
		block: {
			type: Boolean,
...
:host ::slotted(cfpb-list-item) {
  position: relative;
  margin-top: 1px;
}
:host ::slotted(cfpb-list-item)::before, :host ::slotted(cfpb-list-item)::after {
  position: absolute;
  content: "";
  display: block;
  width: 100%;
...
:host ::slotted(cfpb-list-item)::before {
  top: -1px;
  border-top: 1px solid var(--gray-20);
}
:host ::slotted(cfpb-list-item)::after {
  bottom: -1px;
...
:host([type=plain]) .checkbox::before {
  border-color: transparent;
  outline-color: transparent;
  background-color: transparent;
}
...
:host .a-tagline__text {
  display: inline-block;
}
:host .a-tagline cfpb-flag-usa {
  margin-top: 1px;
}
:host .a-tagline--large {
  font-size: 1rem;
}
:host .a-tagline--large cfpb-flag-usa {
  margin-top: 4px;
}
@media print {
  :host .a-tagline {
...
:host html[lang=ar] {
  direction: rtl;
  padding-right: 0;
}`, kr = ["CFPB-TAG-FILTER", "CFPB-TAG-TOPIC"], Ar = class e extends X {
	static styles = Or;
	static properties = {
		childData: {
			type: String,
...
:host .o-select:focus, :host .o-select:focus-within {
...
:host .o-select__cues .o-select__cue-close,
:host .o-select__cues .o-select__cue-open {
  display: none;
}
:host .o-select__cues[aria-expanded=false] .o-select__cue-open {
  display: block;
  margin-top: -1px;
}
:host .o-select__cues[aria-expanded=true] .o-select__cue-close {
  display: block;
  margin-top: -5px;
}
:host .o-select .no-results {
  padding: 6.5px 10px;
}
:host .o-select button.o-select__cues {
  background: var(--select-icon-bg-default);
  border-left: 1px solid var(--select-border-default);
}
:host .o-select__label {
  display: flex;
  justify-content: space-between;
  align-items: center;
  gap: 10px;
...
:host .o-select__content::after {
  padding-bottom: 0.9375em;
  width: 100%;
}
:host .o-select--down::before {
  bottom: -1px;
}
:host .o-select--down .o-select__content {
  border-top: 0;
  top: 35px;
}
:host .o-select--up .o-select__content {
  border-bottom: 0;
  top: unset;
}
@media print {
  :host .o-select__cues[aria-expanded=true] :host .o-select__cue-close, :host .o-select__cues[aria-expanded=false] :host .o-select__cue-open {
    display: none;
  }
  :host .o-select__content[aria-expanded=false] {
    display: block;
    max-height: 99999px !important;
  }
}

:host([open]) .o-select::before {
  position: absolute;
  z-index: 11;
  content: "";
  display: block;
...
:host .m-pagination__current-page {
  width: 2.8125rem;
  font-weight: 500;
  text-align: right;
}
:host .m-pagination__label {
  display: contents;
  white-space: nowrap;
}
:host .m-pagination__btn-prev {
  grid-area: pag-btn-prev;
  z-index: 1;
}
:host .m-pagination__btn-next {
...
//#endregion
export { me as AlphaTransition, h as BEHAVIOR_PREFIX, A as BaseTransition, Rn as CfpbButton, Xn as CfpbExpandable, ar as CfpbFileUpload, Kn as CfpbFormAlert, rr as CfpbFormChoice, yr as CfpbFormSearch, _r as CfpbFormSearchInput, cr as CfpbLabel, pr as CfpbList, dr as CfpbListItem, Hr as CfpbPagination, Ir as CfpbSelect, Tr as CfpbTagFilter, Ar as CfpbTagGroup, Dr as CfpbTagTopic, Cr as CfpbTagline, _ as EventObserver, I as Expandable, be as ExpandableGroup, ve as ExpandableGroupStyles, _e as ExpandableStyles, j as FlyoutMenu, m as JS_HOOK, f as MOBILE, N as MaxHeightTransition, ge as MoveTransition, Ye as Multiselect, g as STATE_PREFIX, Se as Summary, we as SummaryMinimal, xe as SummaryStyles, y as add, at as bannerStyles, i as baseStyles, ee as behaviorAttach, O as behaviorFind, o as buttonGroupStyles, s as buttonLinkStyles, a as buttonStyles, Qe as cardGroupStyles, Ze as cardStyles, D as checkBehaviorDom, C as checkDom, v as contains, lt as dateStyles, $e as emailSignupStyles, et as featuredContentModuleStyles, Ee as formAlertStyles, De as formFieldStyles, Te as formStyles, tt as heroStyles, Xe as iconStyles, T as instantiateAll, se as isArray, oe as isDate, ne as isDefined, le as isEmpty, ce as isFunction, ue as isMobileUserAgent, ae as isNumber, re as isObject, ie as isString, te as isUndefined, Oe as labelStyles, nt as layoutStyles, ut as linkStyles, dt as listStyles, ft as metaHeaderStyles, r as normalizeStyles, ot as notificationStyles, st as paginationStyles, pt as pullQuoteStyles, ke as rangeStyles, Ae as searchInputStyles, je as selectStyles, w as setInitFlag, mt as slugHeaderStyles, ct as tableStyles, Me as tagStyles, ht as taglineStyles, Ne as textInputStyles, rt as textIntroductionStyles, c as utilitiesStyles, n as varsBreakpoints, p as viewportIsIn, it as wellStyles };
