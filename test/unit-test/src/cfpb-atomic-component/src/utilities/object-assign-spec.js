...
describe('object-assign', () => {
  ...
  it('should assign properties from source to destination', () => {
    ...
    expect(Object.prototype.hasOwnProperty(testObjectA, 'obj')).toBe(true);
    expect(Object.prototype.hasOwnProperty(testObjectA, 'arr')).toBe(true);
    expect(Object.prototype.hasOwnProperty(testObjectA, '_null')).toBe(true);
  });
  ...
  it('should assign multiple source properties to destination', () => {
    ...
    expect(Object.prototype.hasOwnProperty(testObjectA, 'bool')).toBe(true);
    expect(Object.prototype.hasOwnProperty(testObjectA, 'undef')).toBe(true);
    expect(Object.prototype.hasOwnProperty(testObjectA, 'num')).toBe(true);
  });
