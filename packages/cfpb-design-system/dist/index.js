...
var kt = class e extends I {
  ...
  `;
	...
	get #a() {
		return this.linkAttributes.href ? this.inline ? "all" : this.borders === "none" ? "none" : "tablet-up" : "";
	}
	renderLink() {
		return j`
        <slot></slot>
