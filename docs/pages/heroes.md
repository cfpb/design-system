...
variation_groups:
  - variations:
      ...
      - variation_is_deprecated: false
        ...
        variation_code_snippet: >-
          ...
          <style>
              .m-hero__image {
                  background-image:
                      url('/design-system/images/uploads/design_system_jumbo_hero_example.jpeg');
                  background-image: -webkit-image-set(
                      url('/design-system/images/uploads/design_system_jumbo_hero_example.jpeg') 1x,
                      url('/design-system/images/uploads/design_system_jumbo_hero_example.jpeg') 2x
                  );
                  background-image: image-set(
                      url('/design-system/images/uploads/design_system_jumbo_hero_example.jpeg') 1x,
                      url('/design-system/images/uploads/design_system_jumbo_hero_example.jpeg') 2x
      ...
      - variation_is_deprecated: false
        variation_description: If only a heading is provided, the heading becomes an H1, and doesn't become a superheading at large screen sizes.
        variation_code_snippet: >-
          <section class="m-hero m-hero--50-50">
              <div class="m-hero__wrapper">
                  <div class="m-hero__text">
        ...
        variation_specs: >-
          ...
          * Photo dimensions for small screens: 755px (exact) x 575px (maximum)
        variation_name: 50/50 hero - no subheading
      - variation_is_deprecated: false
