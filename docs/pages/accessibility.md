...
accessibility: >-
  ...
  The [WAVE extension](https://wave.webaim.org/extension/) can be installed in your browser and used to check for issues on the page as they relate to accessibility issues.
