    ...
    variations:
      - variation_name: Expandable
        ...
        variation_code_snippet: >-
          ...
          <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/design/V0QJU41AW9fesWLILNybld/branch/i2ipPNAOvyfidTZTO7Nzim/CFPB-Design-System-1.6.0?m=auto&node-id=9038-2316&embed-host=share" allowfullscreen></iframe>
        variation_specs: ""
