...
intro: >-
  ...
  ![Feature
  logo](https://cfpb.github.io/design-manual/static/img/logo/Logo0_@2.png "CFPB
  Logo")
  ...
  The Spanish logo should be used for Spanish language materials, such as
  websites and microsites, publications, and signage.
  ...
  When the logo is being produced for print formats conditions may not allow for
  full color. For these rare cases, the one-color logo may be used only in black
  on a white background.This is applicable for the horizontal, vertical,
  isolated, and small execution lockups.
  ...
  There should always be ample space around the logo to ensure maximum impact
  and keep the mark from looking cluttered.
  ...
  ![Isolated logo clear
  space](https://cfpb.github.io/design-manual/static/img/logo/Logo3.png
  "Isolated logo clear space")
  ...
  ![Vertical logo clear
  space](https://cfpb.github.io/design-manual/static/img/logo/Logo4.png
  "Vertical logo clear space")
