...
#### :house: Internal
* `cfpb-core`
  * [#393](https://github.com/cfpb/design-system/pull/393) Update and clean up dependences ([@anselmbradford](https://github.com/anselmbradford))
* `cfpb-design-system`
  * [#378](https://github.com/cfpb/design-system/pull/378) Simplify build ([@anselmbradford](https://github.com/anselmbradford))

#### Committers: 4
- Ans ([@anselmbradford](https://github.com/anselmbradford))
- Sonna Kim ([@sonnakim](https://github.com/sonnakim))
- [@carolearnest](https://github.com/carolearnest)
- [@kelleyholden](https://github.com/kelleyholden)
...
* `cfpb-design-system`, `cfpb-grid`
  * [#371](https://github.com/cfpb/design-system/pull/371) Remove grid-generated CSS ([@anselmbradford](https://github.com/anselmbradford))
