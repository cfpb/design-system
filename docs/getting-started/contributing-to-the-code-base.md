...
description: >-
  ...
  Details can be found in our <a
  href="https://github.com/cfpb/design-system/blob/master/TERMS.md">TERMS</a>
  and

  <a
  href="https://github.com/cfpb/design-system/blob/master/LICENSE">LICENSE</a>.
  ...
  ([more
  info](https://help.github.com/en/articles/setting-up-your-github-pages-site-locally-with-jekyll#requirements)).
  ...
  features. For more information visit the [Babel documentation
  ...
  Pull Requests for specific labels so if you see a PR missing from the
  changelog,
