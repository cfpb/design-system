...
variation_groups:
  - variations:
    ...
    variation_group_description: Pagination is navigation for paginated content. It
      is used to break long content or large datasets into multiple pages, to
      make it easier for users to consume information.
guidelines: >-
