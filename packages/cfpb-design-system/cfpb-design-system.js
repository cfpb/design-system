  ...
  !( function() {
    ...
    function r( e ) {
      return (
        !n( e, s ) &&
        ( ( function( e, i ) {
          if ( i.indexOf( ' ' ) !== -1 ) throw new Error( 'data-js-hook values cannot contain spaces!' );
    ...
    const l = function() {
      ...
      return (
        ...
        this.dispatchEvent = function( e, i ) {
          if ( !t.hasOwnProperty( e ) ) return this;
          i = i || {};
          for ( let n = t[e], s = 0, r = n.length; s < r; s++ ) n[s].call( this, i );
          return this;
        },
    ...
    function A( t, e ) {
      ...
      try {
        for ( var n, s = t; s; ) if ( i.bind( s )( e ) ? n = s : s = s.parentNode, n ) return s;
      } catch ( t ) {
        return null;
      }
      return null;
