...
description: >-
  ...
  * Is data visualization necessary to help achieve your objective? * Do you
  understand the data set? * What do you want people to walk away knowing?
  ...
  * Who is your audience? * What is their familiarity with data visualization? *
  ...
  * Does your chart have a descriptive title and subtitle so someone who cannot
  see the chart could understand the general trends? * Have you included notes
  and a data source? * Is it clear when the data is from?
  ...
  * Gives an overview of what the graph is about * Uses the h3 heading style * 2
  lines of text maximum

  Subtitle

  * Explains the general trends of the graph and what that means, including why
  it is important * Uses the h4 heading style * 3 lines of text maximum
  ...
  * Provides a link to the URL of a spreadsheet or to the source of the data *
  Important to include for trustworthiness and validity * Allows people to dive
  deeper into the data and explore the nuances for themselves or to replicate
  the visualization
  ...
  * If there are percentages, do they add up to 100? Why not? * What is the
  source of the data?
  ...
  * What is the point of the chart? * Can someone who hasn’t seen the chart
  before figure out the point from a quick look and the title?
