...
var Xe = (e) => {
  ...
  `;
	...
	updated(e) {
		e.has("dividerColor") && (this.dividerColor ? this.style.setProperty("--icon-text-divider", `var(--${this.dividerColor})`) : this.style.removeProperty("--icon-text-divider"));
	}
	render() {
